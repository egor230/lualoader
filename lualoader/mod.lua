...
function mod_block_second_bridge()-- удалить баррикаду на мосте к острову диаса.
 if not check_obj_in_cord(-181.5, -472.6, 11.4, 4)-- проверить есть ли объект в радиусе с координатами.
  then  obj = Createobj(2447, -181.5, -472.6, 11.4)
   wait(2000)  end
  end
